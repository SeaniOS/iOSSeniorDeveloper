//
//  FindTheSmallestMissingPositiveInteger.swift
//  Hackerrank
//
...
class FindTheSmallestMissingPositiveInteger {
    func demo() {
...
extension FindTheSmallestMissingPositiveInteger {
    /// O(n) time
    /// O(1) extra space
    private func findSmallestMissingPositiveSolution(orderNumbers: [Int]) -> Int {
